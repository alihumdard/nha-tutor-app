...
class ExamController extends Controller
{
    ...
    public function startExam(Request $request)
    {
        ...
        // Make the API call with the selected difficulty and a timeout
        try {
            ...
            return redirect()->back()->with('error', 'The exam service is currently unavailable. Please try again later.');
        }
        ...
        return view('pages.exam', ['data' => $result, 'difficulty' => $difficulty, 'submission_id' => $submission->id]);
    }
