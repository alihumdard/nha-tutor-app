...
.progress-bar {
    ...
    background:
        ...
        conic-gradient(#3CB371 25%, #90EE90 0);
        ...
        <main class="flex-grow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    ...
                    <div
                        ...
                        <div class="p-6">
                            <div class="mt-6 flex flex-col items-center justify-center text-center">
                                ...
                                <h1 class="text-xl font-bold pt-6">Progress</h1>
                            </div>
                    ...
                    <!-- Learning Plan Card -->
                    <div class="">
                        <div class="p-6 h-full items-center flex flex-col">
                    ...
                    <div
                        ...
                        <div class="">
                            <div class="p-6 h-full flex flex-col justify-around">
                                <h1 class="text-2xl font-bold text-gray-800 text-center">Exam</h1>
                                <div>
                                    <button
                                        class="w-full bg-[#3CB371] text-white py-3 px-10 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-md">
                                        Start
                                    </button>
                                </div>
                            </div>
                ...
                <div class="w-full py-8 mb-8">
                    <div class="flex flex-col md:flex-row gap-8">
                        <!-- CORE Section -->
                        <div class="w-full md:w-1/2 border shadow-lg">
                            <div class="p-4 mb-6 text-center">
                                <h2 class="font-bold text-xl mb-1">CORE</h2>
                            </div>


                            <div class="grid grid-cols-1 gap-4" id="coreModulesContainer">
                                @php
                                $coreModules = [
                                ...
                                <div class="module-card p-6 flex  h-full"
                                    @if($index>= 9) style="display: none;" @endif>
                                    <div class="flex-grow">
                                        <h3 class="text-gray-800 text-sm font-medium mb-3 text-start">{{ $module }}
                                        </h3>
                                    </div>
                                    <div class="mt-auto text-center">
                                        <button
                                            class="text-blue-600 py-2 px-4 rounded-lg text-md font-medium transition-all duration-300">
                                            Quiz
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 border shadow-lg">
                             <div class="p-4 mb-6 text-center">
                                <h2 class="font-bold text-xl mb-1">LOS</h2>
                            </div>

                            <div class="grid grid-cols-1 gap-4" id="losModulesContainer">
                                @php
                                $losModules = [
                                ...
                                <div class="module-card p-6 flex h-full"
                                    ...
                                    <div class="flex-grow">
                                        <h3 class="text-gray-800 text-sm font-medium mb-3 text-start">
                                            {{ $moduleTitle }}</h3>
                                    </div>
                                    <div class="mt-auto text-center">
                                        <button
                                            class=" py-2 px-4 text-blue-600 rounded-lg text-md font-medium transition-all duration-300">
                                            Quiz
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="mt-6 text-center">
                                <button id="showMoreLosBtn"
                                    class="text-blue-600 font-medium text-sm flex items-center justify-center mx-auto transition-colors duration-300">
                                    Show More Modules
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
