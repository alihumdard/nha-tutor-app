...
<body class="font-sans">
    <header class="d-flex justify-content-between align-items-center px-7 py-3 bg-light flex-column flex-md-row">
        <a href="/" class="text-secondary fw-normal fs-5 text-decoration-none mb-2 mb-md-0"
            style="font-size: larger; color: gray;">
            Unsubscribe
        </a>

        <div class="brand text-dark fw-semibold fs-4 text-center mb-2 mb-md-0">
            NHA Tutor Pro
        </div>
        ...
        <nav>
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="btn btn-link text-decoration-none text-dark fw-medium fs-5 p-0"
                        ...
                        <div class="module-section core-section">
                            ...
                            <div class="show-more-container">
                                <button id="showMoreCoreBtn" class="show-more-button font-bold">
                                    Show More Modules
                                    <svg xmlns="http://www.w3.org/2000/svg" class="chevron-icon" fill="none"
                ...
                <div class="bottom-nav">
                    <div class="nav-items">
                        ...
                        <a href="{{ route('quiz') }}" class="nav-link group">
                            <div class="icon-wrapper">
                                <svg class="icon indigo" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <a href="{{ route('admin.crm.edit') }}" class="nav-link group">
                            <div class="icon-wrapper">
                                <svg class="icon blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 4h16v4H4zm0 6h16v4H4zm0 6h16v4H4z" />
                                </svg>
                            </div>
                            <span class="label text-center text-md-start w-100">CMS</span>
                        </a>


                        <a href="{{ route('terms') }}" class="nav-link group">
                            <div class="icon-wrapper">
                                <svg class="icon orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
