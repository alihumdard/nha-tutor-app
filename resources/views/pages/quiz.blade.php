      ...
      <article class="lesson-content">
        ...
        <section class="content-block-gray">
          @foreach($question['options'] as $option)
            <input type="radio" id="question-{{ $key }}" value="{{ $option }}" name="question-{{ $key }}">
            <label for="question-{{ $key }}" style="margin-bottom: 5px;">{{ $option }}</label>
          @endforeach
        </section>

        <section class="content-block-green">
          <div class="accordion">
            <p><b>Answer</b> <span class="arrow">&#9654;</span></p>
          </div>
          <div class="panel">
            <p>
        ...
        <section class="content-block-green">
          <div class="accordion">
            <p><b>Explanation</b> <span class="arrow">&#9654;</span></p>
          </div>
          <div class="panel">
            <p>
